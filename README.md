# 📝 Práctico Nº 1: Prolog
**Tema central:** Manejo de listas, conjuntos, estructuras de datos (árboles y bags) y lógica de Prolog.

---

## 📋 Ejercicio 1: Equivalencia de Listas
Indique cuáles de las siguientes listas son equivalentes a la lista original ``:
